...
public class GUI extends JPanel 
{
	...
	public GUI()
	{
		...
		ImageIcon icon = new ImageIcon("C:\\Users\\hajar\\Downloads\\COMP-SCI 449 - Found of SE\\CS449_Sprint2_Hajar_Wilkes\\Sprint2Proj\\src\\image.ico");
		...
		for (int j = 0; j < 7; j++) { // for each column 
			if ((i < 2 || i > 4)&& (j < 2 || j > 4)){
				// Add nothing, this are invalid spaces meant to be empty
					...
					button.setIcon(new ImageIcon("C:\\Users\\hajar\\Downloads\\COMP-SCI 449 - Found of SE\\CS449_Sprint2_Hajar_Wilkes\\Sprint2Proj\\src\\image.ico"));
