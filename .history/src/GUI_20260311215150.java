...
public class GUI extends JPanel {
    ...
    public GUI() {
        ...
        hexagonRadio.setBounds(10, 90, 130, 30); // Placed just below the English button
        ...
        for (int row = 0; row < 7; row++) {
            for (int col = 0; col < 7; col++) {
                ...
                if (!isCorner) {
                    ...
                    // SHIFTED RIGHT: The 'x' coordinate now adds 150px instead of 25px
    ...
    public static void main(String[] args) {
        ...
        // WIDENED THE FRAME: Increased width from 450 to 580 to fit the new left menu
