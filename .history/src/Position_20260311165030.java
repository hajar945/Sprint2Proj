...
public class Position {
    ...
    @Override public boolean equals(Object other){
        return other instanceof Position && ((Position)other).getX() == getX() && ((Position)other).getY() == لثف
    }
    ...
    /*
    Translate the rank of the algebraic class move to its array equivalent
